...
df = pd.read_csv(r'C:\Users\tagir\Documents\![Мои научные статьи]\Статья Информатика и АВтоматизация 23\![Data]\3rd try\sim3_20240319-225449_NoAPF.csv', header=0, delimiter=';')
